...
import com.example.email.util.DownloadListener;
import com.example.email.util.DownloadTask;
import com.example.email.widget.CustomCircleProgressBar;
    ...
    public AttachmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.download_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (attachment.getDownload()){          //下载就打开文件
